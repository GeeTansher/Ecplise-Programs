...
public class putOnLandscape {
	...
	public static void main(String[] args) {
		...
		Mat image = Imgcodecs.imread("images/Screenshot_20221211_155418.png");
		int width = 1920;
	    int height = 1080;
...
//	    Rectangle parameters
	    int x= 320, y =  height-350, w=1595, h=330;
	    int x1= 1470, y1 =  height-415, w1=445, h1=80;
	    ...
	    overlay = puttext(overlay, 1545, height-370, "GPS Map Camera",27, Imgproc.FONT_HERSHEY_SIMPLEX, 4);
	    overlay = puttext(overlay, 335, height-300, text, 35, Imgproc.FONT_HERSHEY_SIMPLEX, 6);
	    int extra = 0;
	    for(String s : texts) {
	    	overlay = puttext(overlay, 335, height-240+extra, s, 22, Imgproc.FONT_HERSHEY_SIMPLEX, 3);
	    	extra+=50;
	    }
	    ...
	    image_new = putimg(image_new, Imgcodecs.imread("images/small gps.jpg"),35 ,35 ,1490, height-400);
